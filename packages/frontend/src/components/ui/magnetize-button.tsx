...
function MagnetizeButton({
    ...
    return (
        <Button
            className={cn(
                "relative touch-none min-w-fit px-6",
                "bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-600 dark:to-purple-700",
                "hover:from-blue-600 hover:to-purple-700 dark:hover:from-blue-700 dark:hover:to-purple-800",
                "text-white dark:text-white",
                "border border-blue-400/30 dark:border-purple-400/30",
            ...
            {particles.map((_, index) => (
                <motion.div
                    ...
                    className={cn(
                        ...
                        "bg-blue-300 dark:bg-purple-300",
